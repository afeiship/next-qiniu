 ...
 */
   ...
   */
    ...
    */
			setOption: function setOption(option, value) {
				...
				if (plupload.inArray(option, ['container', 'browse_button', 'drop_element', 'runtimes', 'multi_selection', 'flash_swf_url', 'silverlight_xap_url']) !== -1) {
					this.trigger('Error', {
   ...
   */
			uploadFile: function uploadFile(file, options) {
				var up = this,
  ...
  * @constructor
  */
	var QueueProgress = function QueueProgress() {
